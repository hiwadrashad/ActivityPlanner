using ActivityPlannerBlazor.Shared.WebUtils;
...
using static ActivityPlannerBlazor.Shared.WebUtils.SeleniumWebUtil;
...
namespace UnitTesting.BlackBox
{
    ...
    public class SecurityTesting
    {
        ...
        public void Selenium_CheckGoodWebApplication_PassCsrfTest()
        {
            ...
            //Act
            bool result = TestUrlForCsrfProtection(urlsToTest);
